...
{
    public abstract partial class PopulateEmailCasesBasePlugin : IPlugin
    {
        ...
        /// <summary>
        /// Initializes a new instance of the PopulateEmailCasesBasePlugin class.
        /// </summary>
        internal PopulateEmailCasesBasePlugin(string unsecureConfig, string secureConfig)
        {
    ...
    public struct MessageNames
    {
		...
		public static readonly string dxtools_CreateCustomEmail = "dxtools_CreateCustomEmail";
		public static readonly string dxtools_SendCustomEmail = "dxtools_SendCustomEmail";
