...
function getData() {
    ...
    XrmServiceToolkit.Rest.RetrieveMultiple("cog_timelineactivitySet", "$select=ActivityId,ActualStart,ActualEnd,Subject,Description,RegardingObjectId&$filter=(RegardingObjectId/Id eq (guid'" + id + "')) or (cog_Consumer/Id eq (guid'" + id + "'))", function (results) {
        records = results;
    },
    function (error) {
