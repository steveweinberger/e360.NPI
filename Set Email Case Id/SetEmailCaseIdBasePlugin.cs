...
{
    public abstract partial class SetEmailCaseIdBasePlugin : IPlugin
    {
        ...
        /// <summary>
        /// Initializes a new instance of the SetEmailCaseIdBasePlugin class.
        /// </summary>
        internal SetEmailCaseIdBasePlugin(string unsecureConfig, string secureConfig)
        {
